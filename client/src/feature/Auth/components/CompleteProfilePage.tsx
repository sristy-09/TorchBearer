      ...
      <div className="max-w-lg mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground text-sm mt-1">
            Welcome, <span className="font-medium text-foreground">{user?.name}</span>! Just a few more details to get started.
          </p>
        </div>
        ...
        <div className="rounded-2xl p-7 border"
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {/* Batch Year */}
            <div className="space-y-1.5">
              <Label htmlFor="batchYear" className="text-sm font-medium text-foreground">Batch year</Label>
              <Input
                id="batchYear"
                name="batchYear"
                type="number"
              ...
              />
              {errors.batchYear && <p className="text-xs text-red-500">{errors.batchYear}</p>}
            </div>

            {/* Registration Number */}
            <div className="space-y-1.5">
              <Label htmlFor="registrationNumber" className="text-sm font-medium text-foreground">Registration number</Label>
              <Input
            ...
            <div className="space-y-2">
              <Label htmlFor="skillInput" className="text-sm font-medium text-foreground">Skills</Label>
                  ...
                  {form.skills.map((skill) => (
                    <span key={skill}
                      ...
                      <button type="button" onClick={() => removeSkill(skill)}
                        className="hover:opacity-70 transition-opacity" aria-label={`Remove ${skill}`}>
                        <X size={11} />
                      </button>
                    </span>
                  ))}
              ...
              {errors.skills
                ...
                : <p className="text-xs text-muted-foreground">Press Enter or comma after each skill</p>
              }
            </div>
            ...
            <div className="space-y-2">
                  ...
                  {form.interests.map((interest) => (
                    <span key={interest}
                      ...
                      <button type="button" onClick={() => removeInterest(interest)}
                        className="hover:opacity-70 transition-opacity" aria-label={`Remove ${interest}`}>
                        <X size={11} />
                      </button>
                    </span>
                  ))}
              ...
              <div className="grid grid-cols-2 gap-2.5 p-4 rounded-xl"
              ...
              <div className="space-y-1.5">
                <Label htmlFor="otherInterest" className="text-xs text-muted-foreground">Other (specify)</Label>
                <Input
                  id="otherInterest"
                  type="text"
              ...
              {errors.interests
                ...
                : <p className="text-xs text-muted-foreground">Select from options or add your own</p>
              }
            </div>
