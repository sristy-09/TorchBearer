...
router.post("/:id/members",restrictTo("admin"), addMemberToSpace); // Add a member to a space
router.delete("/:id/members", restrictTo("admin"),removeMemberFromSpace); // Remove a member from a space
